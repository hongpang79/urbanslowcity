...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/admin/homepage/file_uploader.jsp" method="post" enctype="multipart/form-data" onSubmit="return false;">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:upload();"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="javascript:close();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
