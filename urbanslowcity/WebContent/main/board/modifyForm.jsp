				...
				<table width="1200" height="700" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
    					<td align="center" valign="top">
    									...
    									<form name='com_board' method='post' action='/main/board/modifyProcess.jsp' onSubmit='return com_board_writeformCheck()'>
													...
													<style type="text/css">
														...
														*/
														...
														<tr height='30' class='board'>
															...
															<td class="board_desc"><input title="input" type="text" id='border' name="writer" style="border:1px solid #EAEAEA;height:20px;" maxlength="50" size="50" value="<%=article.getWriter()%>"></td>
														</tr>
														<tr height='30' class='board'>
															<td class="board_bgcolor"><span style="color:#000000;font-size:12px;">비밀번호</span></td>
															<td class="board_desc"><input title="input" type='password' id='border' name='password' style="border:1px solid #EAEAEA;height:20px;" maxlength='20' size='20' /></td>
														</tr>
														<tr height='30' class='board'>
   													...
   													<table border=0 cellpadding=0 cellspacing=0 align=center width='100%'>
   														<tr>
   															...
   															<td class='bbsnewf5' height='34' align='center'>
														      	...
														      	<a href="javascript:location.href='/main/board/view.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>&category=<%=category%>&flag=<%=flag %>&com_board_search_code=<%=comBoardSearchCode %>&com_board_search_value=<%=comBoardSearchValue %>';"><img src='/images/board/cancel.gif' vspace='7' border='0'></a><!-- 취소버튼 -->
														    </td>
														    <td width='62'></td>
														</tr>
													</table>
